          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-right"><?php echo $inventory['action']; ?></td>
              </tr>
              <?php } ?>
              <?php } else { ?>
              <tr>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/inventory&token=<?php echo $token; ?>';
...
$('#button-export').on('click', function() {
  url = 'index.php?route=report/inventory/export&token=<?php echo $token; ?>';
